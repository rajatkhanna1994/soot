...
public abstract class UnitGraph implements DirectedGraph<Unit> {
   ...
   * <tt>UnitGraph</tt>.
   *
   * @param body The body of the method for which to construct a control flow
   *             graph.
   */
   ...
   *
   * @param unitToSuccs A {@link Map} from {@link Unit}s to {@link List}s of
   ...
   * @param unitToPreds A {@link Map} from {@link Unit}s to {@link List}s of
   *                    {@link Unit}s. This is an ``out parameter''; callers must pass
   *                    an empty {@link Map}. <tt>buildUnexceptionalEdges</tt> will
   *                    add a mapping for every <tt>Unit</tt> in the body to a list of
   ...
   *
   * @param unitToSuccs The {@link Map} from {@link Unit}s to {@link List}s of their
   *                    successors.
   * @param unitToPreds The {@link Map} from {@link Unit}s to {@link List}s of their
   *                    successors.
